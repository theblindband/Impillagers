...
public class ModBlocks {
    ...
    public static final Block PURPLE_HEART_PRESSURE_PLATE = registerBlock("purple_heart_pressure_plate", new PressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, AbstractBlock.Settings.create().mapColor(MapColor.PURPLE).instrument(Instrument.BASS).strength(2.0F).sounds(BlockSoundGroup.WOOD), BlockSetType.OAK));
    public static final Block PURPLE_HEART_BUTTON = registerBlock("purple_heart_button", new ButtonBlock(AbstractBlock.Settings.create().mapColor(MapColor.PURPLE).instrument(Instrument.BASS).strength(2.0F).sounds(BlockSoundGroup.WOOD), BlockSetType.OAK, 30, true));
