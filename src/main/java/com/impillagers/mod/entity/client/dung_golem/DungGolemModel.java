...
public class DungGolemModel <T extends DungGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData body = root.addChild("body", ModelPartBuilder.create().uv(0, 0).cuboid(-5.0F, -3.0F, -3.0F, 10.0F, 6.0F, 6.0F, new Dilation(0.0F))
                .uv(0, 12).cuboid(-8.0F, -7.0F, 0.0F, 16.0F, 6.0F, 0.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -6.0F, 0.0F));

        ModelPartData nose = body.addChild("nose", ModelPartBuilder.create().uv(28, 18).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 3.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 1.0F, -3.0F));

        ModelPartData flower = body.addChild("flower", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 6.0F, 0.0F));
        ...
        ModelPartData legs = body.addChild("legs", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 1.0F, 0.0F));

        ModelPartData rightLeg = legs.addChild("rightLeg", ModelPartBuilder.create().uv(12, 24).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 3.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(3.0F, 2.0F, 0.0F));

        ModelPartData leftLeg = legs.addChild("leftLeg", ModelPartBuilder.create().uv(20, 24).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 3.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(-3.0F, 2.0F, 0.0F));
