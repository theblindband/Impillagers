...
public class ModTrades {
    ...
    public static void registerModTrades() {
        ...
        TradeOfferHelper.registerVillagerOffers(Banker.BANKER, 1, factories -> factories.add((entity, random) -> new TradeOffer(
        ...
        TradeOfferHelper.registerVillagerOffers(Banker.BANKER, 2, factories -> factories.add((entity, random) -> new TradeOffer(
        ...
        TradeOfferHelper.registerVillagerOffers(Banker.BANKER, 2, factories -> factories.add((entity, random) -> new TradeOffer(
                ...
                new ItemStack(ModItems.FAKE_GOLD_COIN, 8), 16, 2, 0.04f)));
        //Level 3 - Gold Trades
        TradeOfferHelper.registerVillagerOffers(Banker.BANKER, 3, factories -> factories.add((entity, random) -> new TradeOffer(
        ...
        TradeOfferHelper.registerVillagerOffers(Banker.BANKER, 4, factories -> factories.add((entity, random) -> new TradeOffer(
        ...
        TradeOfferHelper.registerVillagerOffers(Banker.BANKER, 5, factories -> factories.add((entity, random) -> new TradeOffer(
                new TradedItem(ModItems.FAKE_GOLD_COIN, 16),
                new ItemStack(ModItems.GOLD_COIN, 1), 16, 2, 0.04f)));

        //Musician
        //Level 1 - Dungeon Discs
        TradeOfferHelper.registerVillagerOffers(Musician.MUSICIAN, 1, factories -> factories.add((entity, random) -> new TradeOffer(
        ...
        TradeOfferHelper.registerVillagerOffers(Musician.MUSICIAN, 2, factories -> factories.add((entity, random) -> new TradeOffer(
        ...
        TradeOfferHelper.registerVillagerOffers(Musician.MUSICIAN, 3, factories -> factories.add((entity, random) -> new TradeOffer(
                new TradedItem(ModItems.GOLD_COIN, 64),
        ...
        TradeOfferHelper.registerVillagerOffers(Musician.MUSICIAN, 4, factories -> factories.add((entity, random) -> new TradeOffer(
        ...
        //Level 5 - Goat Horns
        TradeOfferHelper.registerVillagerOffers(Musician.MUSICIAN, 5, factories -> factories.add((entity, random) -> new TradeOffer(
                new TradedItem(ModItems.GOLD_COIN, 16),
                new ItemStack(Items.GOAT_HORN, 1), 16, 6, 0.04f)));

        //Dung Collector
        //Level 1 - Dirt Type Blocks
        TradeOfferHelper.registerVillagerOffers(DungCollector.DUNG_COLLECTOR, 1, factories -> factories.add((entity, random) -> new TradeOffer(
        ...
        TradeOfferHelper.registerVillagerOffers(DungCollector.DUNG_COLLECTOR, 2, factories -> factories.add((entity, random) -> new TradeOffer(
        ...
        TradeOfferHelper.registerVillagerOffers(DungCollector.DUNG_COLLECTOR, 2, factories -> factories.add((entity, random) -> new TradeOffer(
                ...
                new ItemStack(ModItems.FAKE_GOLD_COIN, 1), 16, 6, 0.04f)));
        //Level 3 - Mud
        TradeOfferHelper.registerVillagerOffers(DungCollector.DUNG_COLLECTOR, 3, factories -> factories.add((entity, random) -> new TradeOffer(
                new TradedItem(ModItems.GOLD_COIN, 8),
        ...
        //Level 4 - Dung Balls
        TradeOfferHelper.registerVillagerOffers(DungCollector.DUNG_COLLECTOR, 4, factories -> factories.add((entity, random) -> new TradeOffer(
                new TradedItem(ModItems.GOLD_COIN, 8),
                new ItemStack(ModItems.DUNG_BALL, 6), 16, 6, 0.04f)));
        //Level 5 - Dung Blocks
        TradeOfferHelper.registerVillagerOffers(DungCollector.DUNG_COLLECTOR, 5, factories -> factories.add((entity, random) -> new TradeOffer(
                new TradedItem(ModItems.GOLD_COIN, 16),
