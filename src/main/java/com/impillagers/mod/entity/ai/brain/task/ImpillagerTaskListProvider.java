...
public class ImpillagerTaskListProvider {
    ...
    public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> createCoreTasks(VillagerProfession profession, float speed) {
        return ImmutableList.of(
                ...
                Pair.of(3, FindNewEnemyTask.create(ENEMY_TYPES, 20, MemoryModuleType.ATTACK_TARGET)),
                Pair.of(3, ImpillagerAttackTask.create(5, 40, 2F)),
                Pair.of(3, ImpillagerAttackMovementTask.create(0.75F, 6, 10, 1.5F)),
                Pair.of(3, new SpawnGolemTask()),
                Pair.of(4, ForgetAttackTargetTask.create()),
                Pair.of(4, new MoveToTargetTask()),
                Pair.of(5, WorkStationCompetitionTask.create()),
                Pair.of(5, new FollowCustomerTask(speed)),
                Pair.of(8, WalkToNearestVisibleWantedItemTask.create(speed, false, 4)),
                Pair.of(10, ImpillagerFindPointOfInterestTask.create(profession.acquirableWorkstation(), MemoryModuleType.JOB_SITE, MemoryModuleType.POTENTIAL_JOB_SITE, true)),
                Pair.of(10, new WalkTowardJobSiteTask(speed)),
                Pair.of(10, TakeJobSiteTask.create(speed)),
                Pair.of(15, FindPointOfInterestTask.create(poiType -> poiType.matchesKey(PointOfInterestTypes.HOME), MemoryModuleType.HOME, false, Optional.of((byte)14))),
                Pair.of(15, FindPointOfInterestTask.create(poiType -> poiType.matchesKey(PointOfInterestTypes.MEETING), MemoryModuleType.MEETING_POINT, true, Optional.of((byte)14))),
                Pair.of(15, GoToWorkTask.create()),
                Pair.of(15, LoseJobOnSiteLossTask.create())
        );
    }
